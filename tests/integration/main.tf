...
# Comprehensive integration test using ALL attributes
# This configuration is used to test CREATE, UPDATE, and DELETE operations
resource "facets_tekton_action_kubernetes" "integration_test" {
  # Required attributes
  name                 = "integration-test-action"
  description          = "Integration test for all provider attributes"
  ...
  steps = [
    # Step 1: With resources and env vars
    {
      name  = "validate"
