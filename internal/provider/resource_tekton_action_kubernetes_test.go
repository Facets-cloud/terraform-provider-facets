...
func TestBuildLabels(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			labels := buildLabels(tt.displayName, tt.resourceName, tt.resourceKind, tt.envUniqueName, tt.clusterID, tt.cloudAction, tt.customLabels)
...
func TestBuildLabelsAutoGeneratedPrecedence(t *testing.T) {
	...
	labels := buildLabels("auto-display", "auto-resource", "auto-kind", "auto-env", "auto-cluster", false, customLabels)
